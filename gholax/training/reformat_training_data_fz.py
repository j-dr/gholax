...
if __name__ == '__main__':
    ...
    Ptrain_all, Ftrain_all = load_training_data('RSDPK.f_z', training_data)
    ...
    try:
        training_data.create_dataset('params_f_z', Ptrain.shape)
    except:
        del training_data['params_f_z']
        training_data.create_dataset('params_f_z', Ptrain.shape)

    training_data['params_f_z'][:] = Ptrain[:]        
    
    try:
        training_data.create_dataset('f_z', Ftrain.shape)
    except Exception as e:
        print(e)
        del training_data['f_z']
        training_data.create_dataset('f_z', Ftrain.shape)
    training_data['f_z'][:] = Ftrain
