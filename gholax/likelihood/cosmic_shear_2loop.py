...
from ..theory.real_space_2loop_matter_power_spectrum import RealSpace2LoopMatterPowerSpectrum
...
class CosmicShear2Loop(GaussianLikelihood):
    def __init__(self, config):
        c = config["likelihood"]["CosmicShear2Loop"]
        ...
        self.likelihood_pipeline.extend(
            [
                ...
                *spectral_equiv_modules,
                ...
                RealSpace2LoopMatterPowerSpectrum(
                    zmin=self.zmin_pk,
                    zmax=self.zmax_pk,
                    nz=self.nz_pk,
                    kmin=self.kmin,
        ...
        super(CosmicShear2Loop, self).__init__(c, config["likelihood"].get('params', {}))
        self.all_spectra = {}
